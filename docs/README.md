...
SkyPilot is a pre-release, independent Hypixel SkyBlock companion. These documents distinguish implemented behavior from architecture that still needs wiring or external activation.
...
- [Hosting portability](portability.md)
