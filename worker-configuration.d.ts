/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production --strict-vars=false` (hash: 9f41750250896548fdbfc5a70dbe5902)
// Runtime types generated with workerd@1.20260811.1 2026-08-21 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	PLAYER_CACHE: KVNamespace;
	DB: D1Database;
	PROVIDER_BUDGET_DB: D1Database;
	...
	ENABLE_ACCOUNT_AUTH: string;
	AUTH_PROVIDER: string;
	ENABLE_PLAYER_LOOKUP: string;
	ENABLE_BROWSER_PLAYER_GATEWAY: string;
	REQUIRE_PLAYER_GATEWAY: string;
	ENABLE_PUBLIC_ECONOMY: string;
	ENABLE_ADS: string;
	ENABLE_PREMIUM: string;
	ENABLE_PUBLIC_PROFILES: string;
	ENABLE_GUILD_TOOLS: string;
	ENABLE_PRICE_ALERTS: string;
	ENABLE_EXPERIMENTAL_FEATURES: string;
	HYPIXEL_API_KEY: string;
	ECONOMY_SERVICE: Fetcher /* skypilot-economy */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SKYPILOT_ENVIRONMENT" | "SITE_NAME" | "SITE_URL" | "ENABLE_AI_ASSISTANT" | "ENABLE_ACCOUNT_AUTH" | "AUTH_PROVIDER" | "ENABLE_PLAYER_LOOKUP" | "ENABLE_BROWSER_PLAYER_GATEWAY" | "REQUIRE_PLAYER_GATEWAY" | "ENABLE_PUBLIC_ECONOMY" | "ENABLE_ADS" | "ENABLE_PREMIUM" | "ENABLE_PUBLIC_PROFILES" | "ENABLE_GUILD_TOOLS" | "ENABLE_PRICE_ALERTS" | "ENABLE_EXPERIMENTAL_FEATURES" | "HYPIXEL_API_KEY">> {}
}
