...
export default function StatusPage() {
  ...
  const services = [
    ...
    { name: "Player analysis", status: playerConfigured ? "Configured" : featureFlags.playerLookup ? "Private service required" : "Disabled by default", detail: playerConfigured ? playerGatewayConfigured ? "The private player service is configured; this page does not spend provider quota to probe it." : "Direct authenticated transport is configured for this deployment." : featureFlags.playerLookup ? "Configure the private player service before enabling live lookup." : "Enable only after credentials and deployment-level abuse controls are ready.", active: playerConfigured },
