...
export default function StatusPage() {
  ...
  const services = [
    ...
    { name: "Player analysis", status: playerConfigured ? "Configured" : featureFlags.playerLookup ? "Credential required" : "Disabled by default", detail: playerConfigured ? "Authenticated transport is configured." : featureFlags.playerLookup ? "Install a replacement Hypixel credential securely." : "Enable only after credentials and deployment-level abuse controls are ready.", active: playerConfigured },
